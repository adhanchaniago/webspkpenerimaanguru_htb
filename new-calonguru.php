...
<h3>TAMBAH DATA CALON GURU</h3>
<div class="panel panel-default">
<div class="table-responsive">
	<table class="table table-bordered table-striped">
		<Tr><td>Id Pendaftar</td><td><input type="text" id="no_calonguru" class="form-control" maxlength="16"></td></Tr>
		<Tr><td>Nama Lengkap</td><td><input type="text" id="nama_lengkap" class="form-control"></td></Tr>
		<Tr><td>Alamat</td><td><input type="text" id="alamat" class="form-control"></td></Tr>
		<Tr><td>No. Telepon</td><td><input type="text" id="no_telp" class="form-control"></td></Tr>
		...
		<Tr><td>Masa Kerja (Tahun)</td><td><input type="text" id="masa_kerja_tahun" class="form-control"></td></Tr>	
		<Tr><td>Masa Kerja (Bulan)</td><td><input type="text" id="masa_kerja_bulan" class="form-control"></td></Tr>	
...
<?php include "fungsi/run_js_guru.php" ?>
</body>
</html>