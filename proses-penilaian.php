...
<div class="col-xs-12 col-sm-9">
	<h3>PROSES PENILAIAN CALON GURU</h3>
		<a href="penilaian-new.php" class="btn btn-primary btn-sm" id="btnNew">Tambah Nilai Calon Guru</a><br><br>
<div class="panel panel-default">
<div class="panel-heading">Note: Jangan Sampai Salah Input Nilai Guru Ya....</div>
...
<?php require("penilaian-tampil.php");?>
</table>
</div>
</div>
</div><!-- /.col-xs-12 main -->
