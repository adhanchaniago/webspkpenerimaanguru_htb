...
<div class="col-xs-12 col-sm-9">
	<h3>TAMBAH SUB KRITERIA DAN BOBOT ASLI</h3>
<div class="panel panel-default">
<div class="table-responsive">
	<table class="table table-striped">
		<tr><td>Pilih Nama Kriteria</td><td>
		<select id="aspek_penilaian" rows="3" class="form-control" onchange="tampilkan()">
  		<?php
		...
		?>
			...
			<?php echo $data['kode'];?></option>
		<?php } ?>
		</select>
		</td></tr>
		<tr><td>Nilai</td><td><input type="text" size="3" id="nilai" value="" class="form-control"></td></tr>
		<tr><td>Keterangan Nilai</td><td><input type="text" size="3" id="keterangannilai" value="" class="form-control"></td></tr>
...
<?php include "fungsi/run_js_subkriteria.php" ?>
</body>
</html>