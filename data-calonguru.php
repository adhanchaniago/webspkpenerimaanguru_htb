...
<div class="col-xs-12 col-sm-9">
	<h3>DATA CALON GURU:</h3>
		<button class="btn btn-primary btn-sm" id="btnNew" value="Tambah Peserta">Tambah Peserta</button><br><br>
...
<div class="table-responsive">
	...
	<th>Tombol Aksi Data</th></thead>
<?php require('tampil-data-calonguru.php');?>
</table>
</div>
</div> 
</div><!-- /.col-xs-12 main -->
