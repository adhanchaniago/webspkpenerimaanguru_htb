...
window.location.href="new-calonguru.php";
});
});
</script>
<script language="javascript">
$(document).ready(function(){
	$("#btnSave").click(function(){
		...
		var dataString= 'no_calonguru='+no_calonguru + '&nama_lengkap='+nama_lengkap +'&alamat='+alamat +
						'&no_telp='+no_telp +'&jenkel='+jenkel +'&masa_kerja_tahun='+masa_kerja_tahun + '&masa_kerja_bulan='+masa_kerja_bulan;
	if(no_calonguru==''){
