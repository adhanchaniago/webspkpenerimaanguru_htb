...
?>
		...
		<hr>
		<center>DAFTAR PESERTA LULUS PENERIMAAN GURU</center></h3>	
		</div>
		</div>
<?php
		echo "<div class='panel panel-info'>";
		echo "<div class='panel-heading'><strong><center>Daftar Peserta Lulus: </strong>Dari Nilai tertinggi</center></div>";
