<?php include "fungsi/cek_ubahnilai.php" ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="table-responsive">
	<table class="table table-bordered table-striped">
		<input type="hidden" id="nilai_lama" value="<?php echo $row->nilai?>">
			<Tr><td>Nilai Minimum Kelulusan</td><td><input type="text" id="nilai" class="form-control" maxlength="16" value="<?php echo $row->nilai?>"></td></Tr>
...
<?php include "fungsi/run_js_updatenilai.php" ?>
</body>
</html>