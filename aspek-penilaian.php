...
<div class="col-xs-12 col-sm-9">
	<h3>KRITERIA</h3>
		<a href="new-aspek.php" class="btn btn-primary btn-sm" id="btnNew">Tambah kriteria</a><br><br>
<div class="panel panel-default">
<div class="panel-heading">Note: Seluruh bobot aspek dijumlahkan harus = 100.</div>
<div class="table-responsive">
	<table class="table table-bordered table-striped">
		<thead>
            <th>Id</th>
            <th>Kode Kriteria</th>
            <th>Nama Kriteria</th><th>Deskripsi</th><th>Bobot</th>
            <th>Action</th></thead>
<?php require('tampil-aspek-penilaian.php');?>
</table>
</div>
</div>
</div><!-- /.col-xs-12 main -->
