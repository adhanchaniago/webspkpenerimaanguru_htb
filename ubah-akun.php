<?php include "fungsi/cek_ubahakun.php" ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="col-xs-6 col-sm-3 sidebar-offcanvas" id="sidebar" role="navigation">
	<ul class="nav">
		...
		<li><a href="#"><span class="glyphicon glyphicon-user"></span> Pengaturan Akun</a></li>
...
<div class="table-responsive">
	<table class="table table-bordered table-striped">
		<input type="hidden" id="userid_lama" value="<?php echo $row->userid?>">
			<Tr><td>Username</td><td><input type="text" id="userid" class="form-control" maxlength="16" value="<?php echo $row->userid?>" disabled="disabled"></td></Tr>
			<Tr><td>Password</td><td><input type="text" id="password" class="form-control" value="<?php echo $row->password?>"></td></Tr>
...
<?php include "fungsi/run_js_updateakun.php" ?>
</body>
</html>